...
```{r fig.cap="Figure 14. Random intercept effects of season_year and state on American Bittern observations from the mixed model. Positive values indicate above-average observation rates relative to the grand mean.", fig.align='center'}
library(sjPlot)
